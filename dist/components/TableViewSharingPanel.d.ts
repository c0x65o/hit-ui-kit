...
export declare function TableViewSharingPanel({ viewId, shares, setShares, sharesLoading, pendingRecipients, setPendingRecipients, addShare, removeShare, allowPrincipalTypeSelection, }: TableViewSharingPanelProps): import("react/jsx-runtime").JSX.Element;
export {};
