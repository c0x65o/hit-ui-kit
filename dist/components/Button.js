...
export function Button({ variant = 'primary', size = 'md', loading, disabled, type = 'button', onClick, className, title, 'aria-label': ariaLabel, children, }) {
    ...
    return (_jsxs("button", { type: type, disabled: isDisabled, onClick: onClick, className: className, title: title, "aria-label": ariaLabel, style: styles({
            display: 'inline-flex',
            alignItems: 'center',
