...
export function Autocomplete({ label, placeholder = 'Search…', value, onChange, disabled = false, minQueryLength = 2, debounceMs = 300, limit = 10, onSearch, resolveValue, emptyMessage = 'No results', searchingMessage = 'Searching…', clearable = true, }) {
    ...
    return (_jsxs("div", { ref: containerRef, style: styles({ position: 'relative' }), children: [label && (_jsx("label", { style: styles({
                    ...
                    marginBottom: spacing.xs,
                        ...
                        }, onKeyDown: onKeyDown, placeholder: placeholder, disabled: disabled, role: "combobox", "aria-autocomplete": "list", "aria-expanded": open, "aria-controls": listboxId, "aria-activedescendant": highlightedIndex >= 0 ? `${listboxId}-opt-${highlightedIndex}` : undefined, style: styles({
                            width: '100%',
